...
define("May", "Gegužė");
define("June", "Birželis");
define("July", "Liepa");
define("August", "Rugpjūtis");
define("September", "Rugsėjis");
...
define("Jun", "Birželis");
define("Jul", "Liepa");
define("Aug", "Rugpjūtis");
define("Sep", "Rugsėjis");
define("Oct", "Spalis");
define("Nov", "Lapkritis");
define("Dec", "Gruodis");
...
define("Wednesday", "Trečiadienis");
define("Thursday", "Ketvirtadienis");
define("Friday", "Penktadienis");
define("Saturday", "Šeštadienis");
define("Sunday", "Sekmadienis");

#index_small.php
define("SML_PREV", "Atgal");
define("SML_NEXT", "Pirmyn");
define("SML_D0", "Se");
define("SML_D1", "Pi");
define("SML_D2", "An");
define("SML_D3", "Tr");
...
define("BOOKING_FRM_TOTAL", "Viso "); //(used multiple times)
...
define("BOOKING_FRM_PHONE", "Tel. nr."); //(used multiple times)
define("BOOKING_FRM_COMMENTS", "Komentarai administratoriui, kupono kodas"); //(used multiple times)
...
define("RESERV_MSG", "Ačiū, mes Jums išsiuntėme patvirtinimo laišką su mūsų kontaktais. Jei kas pasikeistų būtinai informuokite.");
...
define("YNAME", "Jūsų vardas"); //(used multiple times)
define("BOOKING_FORM", "Rezervacija"); //(used multiple times)

#eventlist.php
define("WELCM_SYSTM", "Welcome to our booking system.");
define("SAMPLE_TEXT", "Pasirinkite laiką kada norėtumėte rezervuoti Zombie Bunker.");
...
define("BACK_RETURN", "Grįžti į kalendorių");
...
define("BEP_14", "Ačiū už rezervaciją"); //h1 page title - used multiple times
define("BEP_15", "&laquo; Grįžti į kalendorių"); //used multiple times
define("BEP_16", "Payment For order "); //payment order
define("SEL_TIME", "Pasirinkite norimą laiką."); // used multiple times
...
#functions.php
define("ZERO_SPACES", "vietų nėra");
define("ZERO_SPACES2", "vietų nėra");
define("SPC_AVAIL", " galimos sesijos");
...
define("TXT_FUNC_THANK_YOU_MSG", "<p>Ačiū už rezervaciją. Mes išsiuntėme Jums savo kontaktus - būtinai informuokite, jei kas pasikeistų.</p>");
...
define("TXT_COUPON_CODE", "Įveskite savo kodą (jei tokį turite) ");

#order summery text
define("ORDER_BOOKING_INF", "Informacija");
define("ORDER_EVENT_INF", "Event Information");
define("ORDER_BOOKING_DATE", "Rezervacijos data");
define("ORDER_BOOKING_TIME", "Rezervacijos laikas");
define("ORDER_BOOKING_QTY", "Kiekis");
